...
(function(e, t) {
    ...
    function s(t, n, r) {
        ...
        if (!i) return;
        var s = !!t.cyclePause;
        if (s && i.paused) i.paused(t, i, n, r);
        else if (!s && i.resumed) i.resumed(t, i, n, r)
    }
    ...
    function o(n, r, o) {
        function l(t, n, r) {
            if (!t && n === true) {
                ...
                if (!s) {
                    i("options not found, can not resume");
                    return false
                }
                if (r.cycleTimeout) {
        ...
        if (r.constructor == String) {
            switch (r) {
                ...
                case "stop":
                    ...
                    if (!u) return false;
                    n.cycleStop++;
                    if (n.cycleTimeout) clearTimeout(n.cycleTimeout);
                    n.cycleTimeout = 0;
                    if (u.elements) e(u.elements).stop();
                    e(n).removeData("cycle.opts");
                    if (r == "destroy") a(n, u);
                    return false;
                case "toggle":
                    n.cyclePause = n.cyclePause === 1 ? 0 : 1;
                    l(n.cyclePause, o, n);
                    s(n);
                    return false;
                case "pause":
                ...
                case "next":
                    ...
                    if (!u) {
                        i('options not found, "prev/next" ignored');
                        return false
                    }
                    if (typeof o == "string") u.oneTimeFx = o;
                    e.fn.cycle[r](u);
                    return false;
                default:
                    r = {
            ...
            return r
        } else if (r.constructor == Number) {
            var f = r;
            r = e(n).data("cycle.opts");
            if (!r) {
                i("options not found, can not advance slide");
                return false
            }
            if (f < 0 || f >= r.elements.length) {
                i("invalid slide index: " + f);
                return false
            }
            r.nextSlide = f;
            if (n.cycleTimeout) {
                clearTimeout(n.cycleTimeout);
                n.cycleTimeout = 0
            }
            if (typeof o == "string") r.oneTimeFx = o;
    ...
    function a(t, n) {
        if (n.next) e(n.next).unbind(n.prevNextEvent);
        if (n.prev) e(n.prev).unbind(n.prevNextEvent);
        if (n.pager || n.pagerAnchorBuilder) e.each(n.pagerAnchors || [], function() {
            this.unbind().remove()
        });
        n.pagerAnchors = null;
    ...
    function f(n, r, o, a, f) {
        var d;
        var y = e.extend({}, e.fn.cycle.defaults, a || {}, e.metadata ? n.metadata() : e.meta ? n.data() : {});
        var b = e.isFunction(n.data) ? n.data(y.metaAttr) : null;
        if (b) y = e.extend(y, b);
        if (y.autostop) y.countdown = y.autostopCount || o.length;
        var w = n[0];
        n.data("cycle.opts", y);
        y.$cont = n;
        ...
        if (!e.support.opacity && y.cleartype) y.after.push(function() {
            u(this, y)
        });
        if (y.continuous) y.after.push(function() {
            p(o, y, 0, !y.backwards)
        });
        l(y);
        if (!e.support.opacity && y.cleartype && !y.cleartypeNoBg) g(r);
        if (n.css("position") == "static") n.css("position", "relative");
        if (y.width) n.width(y.width);
        if (y.height && y.height != "auto") n.height(y.height);
        if (y.startingSlide !== t) {
            y.startingSlide = parseInt(y.startingSlide, 10);
            if (y.startingSlide >= o.length || y.startSlide < 0) y.startingSlide = 0;
            else d = true
        } else if (y.backwards) y.startingSlide = o.length - 1;
        else y.startingSlide = 0;
        if (y.random) {
            y.randomMap = [];
            ...
            if (d) {
                for (var S = 0; S < o.length; S++) {
                    if (y.startingSlide == y.randomMap[S]) {
                        y.randomIndex = S
                    }
                }
            } else {
                y.randomIndex = 1;
                y.startingSlide = y.randomMap[1]
            }
        } else if (y.startingSlide >= o.length) y.startingSlide = 0;
        ...
        r.css({
            ...
            var n;
            if (y.backwards) n = x ? t <= x ? o.length + (t - x) : x - t : o.length - t;
            else n = x ? t >= x ? o.length - (t - x) : x - t : o.length - t;
        ...
        if (y.fit) {
            if (!y.aspect) {
                if (y.width) r.width(y.width);
                if (y.height && y.height != "auto") r.height(y.height)
            } else {
                r.each(function() {
                    var t = e(this);
                    var n = y.aspect === true ? t.width() / t.height() : y.aspect;
                    if (y.width && t.width() != y.width) {
                        t.width(y.width);
                        t.height(y.width / n)
                    }
                    if (y.height && t.height() < y.height) {
                        t.height(y.height);
                        t.width(y.height * n)
                    }
                })
        ...
        if (y.center && !y.fit && !y.slideResize) {
            r.each(function() {
                var t = e(this);
                t.css({
                    "margin-left": y.width ? (y.width - t.width()) / 2 + "px" : 0,
        ...
        var T = (y.containerResize || y.containerResizeHeight) && n.innerHeight() < 1;
        if (T) {
            var N = 0,
                C = 0;
            for (var k = 0; k < o.length; k++) {
                var L = e(o[k]),
                    ...
                    O = L.outerWidth(),
                    M = L.outerHeight();
                if (!O) O = A.offsetWidth || A.width || L.attr("width");
                if (!M) M = A.offsetHeight || A.height || L.attr("height");
                N = O > N ? O : N;
                C = M > C ? M : C
            }
            if (y.containerResize && N > 0 && C > 0) n.css({
                width: N + "px",
                height: C + "px"
            });
            if (y.containerResizeHeight && C > 0) n.css({
                height: C + "px"
            })
        }
        var _ = false;
        if (y.pause) n.bind("mouseenter.cycle", function() {
            ...
            if (_) this.cyclePause--;
            s(w, true)
        });
        if (c(y) === false) return false;
        var D = false;
        a.requeueAttempts = a.requeueAttempts || 0;
        r.each(function() {
            var t = e(this);
            this.cycleH = y.fit && y.height ? y.height : t.height() || this.offsetHeight || this.height || t.attr("height") || 0;
            this.cycleW = y.fit && y.width ? y.width : t.width() || this.offsetWidth || this.width || t.attr("width") || 0;
            if (t.is("img")) {
                var n = this.cycleH === 0 && this.cycleW === 0 && !this.complete;
                if (n) {
                    if (f.s && y.requeueOnImageNotLoaded && ++a.requeueAttempts < 100) {
                        i(a.requeueAttempts, " - img slide not loaded, requeuing slideshow: ", this.src, this.cycleW, this.cycleH);
                        setTimeout(function() {
                            e(f.s, f.c).cycle(a)
                        }, y.requeueTimeout);
                        D = true;
        ...
        if (y.timeout) {
            ...
            if (y.speed.constructor == String) y.speed = e.fx.speeds[y.speed] || parseInt(y.speed, 10);
            if (!y.sync) y.speed = y.speed / 2;
            var P = y.fx == "none" ? 0 : y.fx == "shuffle" ? 500 : 250;
            while (y.timeout - y.speed < P) y.timeout += y.speed
        }
        if (y.easing) y.easeIn = y.easeOut = y.easing;
        if (!y.speedIn) y.speedIn = y.speed;
        if (!y.speedOut) y.speedOut = y.speed;
        y.slideCount = o.length;
        y.currSlide = y.lastSlide = x;
        if (y.random) {
            if (++y.randomIndex == o.length) y.randomIndex = 0;
            y.nextSlide = y.randomMap[y.randomIndex]
        } else if (y.backwards) y.nextSlide = y.startingSlide === 0 ? o.length - 1 : y.startingSlide - 1;
        else y.nextSlide = y.startingSlide >= o.length - 1 ? 0 : y.startingSlide + 1;
        if (!y.multiFx) {
            var H = e.fn.cycle.transitions[y.fx];
            if (e.isFunction(H)) H(n, r, y);
            else if (y.fx != "custom" && !y.multiFx) {
                i("unknown transition: " + y.fx, "; slideshow terminating");
                return false
            }
        }
        var B = r[x];
        if (!y.skipInitializationCallbacks) {
            if (y.before.length) y.before[0].apply(B, [B, B, y, true]);
            if (y.after.length) y.after[0].apply(B, [B, B, y, true])
        }
        if (y.next) e(y.next).bind(y.prevNextEvent, function() {
            return v(y, 1)
        });
        if (y.prev) e(y.prev).bind(y.prevNextEvent, function() {
            return v(y, 0)
        });
        if (y.pager || y.pagerAnchorBuilder) m(o, y);
        h(y, o);
        return y
    }
        ...
        if (t.fx.indexOf(",") > 0) {
            ...
            for (n = 0; n < t.fxs.length; n++) {
                ...
                if (!s || !o.hasOwnProperty(u) || !e.isFunction(s)) {
                    i("discarding unknown transition: ", u);
                    t.fxs.splice(n, 1);
                    n--
                }
            }
            if (!t.fxs.length) {
                i("No valid transitions named; slideshow terminating.");
                return false
            }
        } else if (t.fx == "all") {
            t.multiFx = true;
            ...
            for (var a in o) {
                if (o.hasOwnProperty(a)) {
                    s = o[a];
                    if (o.hasOwnProperty(a) && e.isFunction(s)) t.fxs.push(a)
                }
            }
        }
    ...
    function h(t, n) {
        t.addSlide = function(r, i) {
            var s = e(r),
                o = s[0];
            if (!t.autostopCount) t.countdown++;
            n[i ? "unshift" : "push"](o);
            if (t.els) t.els[i ? "unshift" : "push"](o);
            ...
            if (!e.support.opacity && t.cleartype && !t.cleartypeNoBg) g(s);
            if (t.fit && t.width) s.width(t.width);
            if (t.fit && t.height && t.height != "auto") s.height(t.height);
            o.cycleH = t.fit && t.height ? t.height : s.height();
            o.cycleW = t.fit && t.width ? t.width : s.width();
            s.css(t.cssBefore);
            if (t.pager || t.pagerAnchorBuilder) e.fn.cycle.createPagerAnchor(n.length - 1, o, e(t.pager), n, t);
            if (e.isFunction(t.onAddSlide)) t.onAddSlide(s);
            else s.hide()
        }
    }
    ...
    function p(n, i, s, o) {
        function m() {
            ...
            if (i.timeout && !i.continuous) {
                e = d(n[i.currSlide], n[i.nextSlide], i, o);
                if (i.fx == "shuffle") e -= i.speedOut
            } else if (i.continuous && u.cyclePause) e = 10;
            if (e > 0) u.cycleTimeout = setTimeout(function() {
                p(n, i, 0, !i.backwards)
            }, e)
        }
        var u = i.$cont[0],
        ...
        if ((s || !u.cyclePause) && i.nextSlide != i.currSlide) {
            ...
            if (i.multiFx) {
                if (o && (i.lastFx === t || ++i.lastFx >= i.fxs.length)) i.lastFx = 0;
                else if (!o && (i.lastFx === t || --i.lastFx < 0)) i.lastFx = i.fxs.length - 1;
                c = i.fxs[i.lastFx]
            }
            if (i.oneTimeFx) {
                c = i.oneTimeFx;
            ...
            if (i.before.length) e.each(i.before, function(e, t) {
            ...
            i.busy = 1;
            if (i.fxFn) i.fxFn(a, f, i, h, o, s && i.fastOnEvent);
            else if (e.isFunction(e.fn.cycle[i.fx])) e.fn.cycle[i.fx](a, f, i, h, o, s && i.fastOnEvent);
            else e.fn.cycle.custom(a, f, i, h, o, s && i.fastOnEvent)
        } else {
            m()
        }
        if (l || i.nextSlide == i.currSlide) {
            ...
            if (i.random) {
                ...
                if (i.nextSlide == i.currSlide) i.nextSlide = i.currSlide == i.slideCount - 1 ? 0 : i.currSlide + 1
            } else if (i.backwards) {
                v = i.nextSlide - 1 < 0;
                if (v && i.bounce) {
        ...
        if (l && i.pager) i.updateActivePagerLink(i.pager, i.currSlide, i.activePagerClass)
    }
    ...
    function v(t, n) {
        ...
        if (t.random && r < 0) {
            t.randomIndex--;
            if (--t.randomIndex == -2) t.randomIndex = i.length - 2;
            else if (t.randomIndex == -1) t.randomIndex = i.length - 1;
        ...
        if (e.isFunction(u)) u(r > 0, t.nextSlide, i[t.nextSlide]);
        p(i, t, 1, n);
        return false
    }
    ...
    e.fn.cycle = function(t, n) {
        ...
        return this.each(function() {
            var u = o(this, t, n);
            if (u === false) return;
            u.updateActivePagerLink = u.updateActivePagerLink || e.fn.cycle.updateActivePagerLink;
            if (this.cycleTimeout) clearTimeout(this.cycleTimeout);
            this.cycleTimeout = this.cyclePause = 0;
            this.cycleStop = 0;
            var a = e(this);
            var l = u.slideExpr ? e(u.slideExpr, this) : a.children();
            var c = l.get();
            if (c.length < 2) {
    ...
    e.fn.cycle.resetState = function(t, n) {
        ...
        if (e.isFunction(r)) r(t.$cont, e(t.elements), t)
    };
    ...
    e.fn.cycle.createPagerAnchor = function(t, n, i, o, u) {
        ...
        var c = function(n) {
            ...
            if (e.isFunction(s)) s(u.nextSlide, o[u.nextSlide]);
            p(o, u, 1, u.currSlide < t)
        };
        if (/mouseenter|mouseover/i.test(u.pagerEvent)) {
            f.hover(c, function() {})
        } else {
            f.bind(u.pagerEvent, c)
        }
        if (!/^click/.test(u.pagerEvent) && !u.allowPagerClickBubble) f.bind("click.cycle", function() {
            return false
        });
        var h = u.$cont[0];
        var d = false;
    ...
    e.fn.cycle.hopsFromLast = function(e, t) {
        var n, r = e.lastSlide,
            i = e.currSlide;
        if (t) n = i > r ? i - r : e.slideCount - r;
        else n = i < r ? r - i : r + e.slideCount - i;
        return n
    };
    e.fn.cycle.commonReset = function(t, n, r, i, s, o) {
        e(r.elements).not(t).hide();
        if (typeof r.cssBefore.opacity == "undefined") r.cssBefore.opacity = 1;
        r.cssBefore.display = "block";
        if (r.slideResize && i !== false && n.cycleW > 0) r.cssBefore.width = n.cycleW;
        if (r.slideResize && s !== false && n.cycleH > 0) r.cssBefore.height = n.cycleH;
        r.cssAfter = r.cssAfter || {};
        r.cssAfter.display = "none";
        e(t).css("zIndex", r.slideCount + (o === true ? 1 : 0));
        e(n).css("zIndex", r.slideCount + (o === true ? 0 : 1))
    };
    e.fn.cycle.custom = function(t, n, r, i, s, o) {
        ...
        a.css(r.cssBefore);
        if (o) {
            if (typeof o == "number") f = l = o;
            else f = l = 1;
            c = h = null
        }
        var v = function() {
            a.delay(p).animate(r.animIn, f, c, function() {
                i()
            })
        };
        u.delay(d).animate(r.animOut, l, h, function() {
            u.css(r.cssAfter);
            if (!r.sync) v()
        });
        if (r.sync) v()
...
(function(e) {
    ...
    e.fn.cycle.transitions.slideX = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e(r.elements).not(t).hide();
            e.fn.cycle.commonReset(t, n, r, false, true);
    ...
    e.fn.cycle.transitions.slideY = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e(r.elements).not(t).hide();
            e.fn.cycle.commonReset(t, n, r, true, false);
    ...
    e.fn.cycle.transitions.shuffle = function(t, n, r) {
        ...
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, true, true)
        });
        if (!r.speedAdjusted) {
            r.speed = r.speed / 2;
            r.speedAdjusted = true
        }
        r.random = 0;
        r.shuffle = r.shuffle || {
            left: -s,
        ...
        r.fxFn = function(t, n, r, i, s) {
            ...
            o.animate(r.shuffle, r.speedIn, r.easeIn, function() {
                ...
                for (var a = 0; a < n; a++) {
                    if (s) r.els.push(r.els.shift());
                    else r.els.unshift(r.els.pop())
                }
                if (s) {
    ...
    e.fn.cycle.transitions.zoom = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, false, false, true);
    ...
    e.fn.cycle.transitions.fadeZoom = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, false, false);
            r.cssBefore.left = n.cycleW / 2;
            r.cssBefore.top = n.cycleH / 2;
            e.extend(r.animIn, {
                top: 0,
    ...
    e.fn.cycle.transitions.curtainX = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, false, true, true);
            r.cssBefore.left = n.cycleW / 2;
            r.animIn.left = 0;
            r.animIn.width = this.cycleW;
    ...
    e.fn.cycle.transitions.curtainY = function(t, n, r) {
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, false, true);
            r.cssBefore.top = n.cycleH / 2;
            r.animIn.top = 0;
            r.animIn.height = n.cycleH;
    ...
    e.fn.cycle.transitions.cover = function(t, n, r) {
        ...
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r);
            r.cssAfter.display = "";
            if (i == "right") r.cssBefore.left = -s;
            else if (i == "up") r.cssBefore.top = o;
            else if (i == "down") r.cssBefore.top = -o;
            else r.cssBefore.left = s
        });
        r.animIn.left = 0;
        r.animIn.top = 0;
        r.cssBefore.top = 0;
    ...
    e.fn.cycle.transitions.uncover = function(t, n, r) {
        ...
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, true, true);
            if (i == "right") r.animOut.left = s;
            else if (i == "up") r.animOut.top = -o;
            else if (i == "down") r.animOut.top = o;
            else r.animOut.left = -s
        });
        r.animIn.left = 0;
        r.animIn.top = 0;
        r.cssBefore.top = 0;
    ...
    e.fn.cycle.transitions.toss = function(t, n, r) {
        ...
        r.before.push(function(t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, true, true);
            if (!r.animOut.left && !r.animOut.top) e.extend(r.animOut, {
                left: i * 2,
                top: -s / 2,
                opacity: 0
            });
            else r.animOut.opacity = 0
        });
        r.cssBefore.left = 0;
        r.cssBefore.top = 0;
        r.animIn.left = 0
    ...
    e.fn.cycle.transitions.wipe = function(t, n, r) {
        ...
        r.before.push(function(t, n, r) {
            ...
            var o = e(t),
                u = e(n);
            e.fn.cycle.commonReset(t, n, r, true, true, false);
            r.cssAfter.display = "block";
            var a = 1,
                f = parseInt(r.speedIn / 13, 10) - 1;
            (function d() {
                var e = l ? l - parseInt(a * (l / f), 10) : 0;
                var t = p ? p - parseInt(a * (p / f), 10) : 0;
                var n = h < s ? h + parseInt(a * ((s - h) / f || 1), 10) : s;
                var r = c < i ? c + parseInt(a * ((i - c) / f || 1), 10) : i;
                u.css({
